...
const PreInput = ({defaultvalue,inputlabel, onChange, inputtype = 'text'}) => {
    return (
        <div className= 'PrefilledInputBox'>
            <label>{inputlabel}</label>
            <input value = {defaultvalue} type = {inputtype} placeholder= 'Type Here' onChange= {(e)=>onChange(e.target.value)} />
